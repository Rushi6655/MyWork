...
<body>
    ...
    %>
     	...
     	alert("Invalid User! kindly Sign up");
     	</script>
...
<header class="header">
    ...
    <a data-aos="zoom-in-left" data-aos-delay="1300" href="#book-forms" class="btn">Sign Up</a>
    </div>
</header>
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <h3 data-aos="fade-up" data-aos-delay="300">User Login Page </h3>
...
<section class="book-form" id="book-form">
    <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
        <h1 class="myh">Log in</h1>
    </div>
    <form action="userlogin" method="post">
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>Mail Id</span>
            <input type="email" placeholder="place name" value="" name="umail">
        </div>
...
<section class="book-form" id="book-forms">
    <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
        <h1 class="myh">Sign up</h1>
    </div>
    <form action="usersignup" method="post">
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>Name</span>
            <input type="text" placeholder="place name" value="" name="uname">
        </div>
        <div data-aos="zoom-in" data-aos-delay="150" class="inputBox">
            <span>Mail Id</span>
            <input type="email" placeholder="place name" value="" name="umail">
        ...
        <input data-aos="zoom-in" data-aos-delay="600" type="submit" value="Sign Up" class="btn">
    </form>
